...
<p align="center">
  <i align="center">Eclipse's mosquitto, an open source <b>mqtt broker</b> for <b>swift</b>.</i>
</p>
...
##### To add this package to your own project, add the following to your `Package.swift`.
```swift
...
let package = Package(
  ...
  dependencies: [
    // 1.
    .package(url: "https://github.com/wabiverse/swift-mosquitto.git", branch: "main"),
  ],
  targets: [
    .target(
      name: "MyTarget",
...
###### **SwiftMosquitto** is licensed under the terms of the Apache 2.0 License.
